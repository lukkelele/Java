 ...
 * ConsoleUI is responsible for handling I/O operations.
 * It is used by controller.User to get input and to get sent information to 
...
public class ConsoleUI {
  ...
  public String editName(String firstName, String lastName) { // Same as enterMemberId, but to keep things loosely coupled, separate
  ...
  /**
   * Displays a question if the user wishes to delete a member (resigning their membership, since deleting anyone except themselves is not allowed).
   */
